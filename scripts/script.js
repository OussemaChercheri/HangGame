...
const resetGame = () => {
    ...
    correctLetters = [];
    wrongGuessCount = 0;
    hangmanImage.src = `images/hangman-${wrongGuessCount+4}.png`;
...
const gameOver = (isVictory) => {
    // After 600ms of game complete.. showing modal with relevant datails
    setTimeout(()=>{
...
const initGame = (button, clickedLetter) => {
    ...
    if (currentWord.includes(clickedLetter)) {
        ...
        // If clicked letter dosen't exist then update the wrongGussCount and human image
        wrongGuessCount++;
        hangmanImage.src = `images/hangman-${wrongGuessCount+4}.png`;
    }
